  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-black uppercase tracking-tighter">WAWASAN <span className="text-gold">OTOMOTIF</span></h1>
        <Link href="/admin/insights/new" className="btn-gold text-xs px-4 py-2 flex items-center gap-2">
          <Plus size={14} />
          Tulis Artikel
        </Link>
      </div>
